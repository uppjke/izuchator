  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        /* ↓↓↓ заменили только эту часть ↓↓↓ */
        "focus:border-blue-500 focus-visible:border-blue-500 focus-visible:ring-blue-500/50",
        ...
        "whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus:outline-none focus-visible:ring-[3px]",
