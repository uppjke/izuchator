  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          // Base styles
          "bg-white text-zinc-900 z-50",
          "min-w-[10rem] sm:min-w-[8rem]",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=destructive]:focus:text-red-600",
        ...
        "data-[inset]:pl-10 sm:data-[inset]:pl-8",
